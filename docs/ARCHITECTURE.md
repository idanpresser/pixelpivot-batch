...
Canonical design and operational notes for **PixelPivot Batch Engine**.
...
PixelPivot Batch Engine is a decoupled microservice system for
high-throughput image conversion. A headless **FastAPI backend**
orchestrates batch jobs; a standalone **Streamlit frontend** communicates
...
[CONTRIBUTING.md](../CONTRIBUTING.md#development-workflow) for the
